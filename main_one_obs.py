# -*- coding: utf-8 -*-
"""
Created on Fri Aug  5 12:55:44 2022
...
# from Helpers import individual_cluster_plots
...
##########################################################################
# observation_ID = '0870830201'
observation_ID = '0864052301'
...
time_dict = {'time_bti_detection': [time_abd - time_bbd],
             ...
             'time_total_without_plots': [time_abd - time_bbd + time_ac - time_bc + time_and - time_bnd + time_ae - time_be + time_acc - time_bcc],
...
# individual_cluster_plots(events_final, final_clusters_HDBSCAN, ID, observation_ID)